...
void DocbookDocVisitor::writeMscFile(const QByteArray &baseName)
{
   QByteArray shortName = baseName;
   int i;
...
void DocbookDocVisitor::writePlantUMLFile(const QByteArray &baseName)
{
   QByteArray shortName = baseName;
   int i;
...
void DocbookDocVisitor::writeDiaFile(const QByteArray &baseName)
{
   QByteArray shortName = baseName;
   int i;
...
void DocbookDocVisitor::writeDotFile(const QByteArray &baseName)
{
   QByteArray shortName = baseName;
   int i;
