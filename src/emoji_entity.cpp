...
EmojiEntityMapper::EmojiEntityMapper()
{
  for (int i = 0; i < g_numEmojiEntities; i++) {
    m_name2sym.insert(QString::fromLatin1(g_emojiEntities[i].name), i);
  }
}
...
int EmojiEntityMapper::symbol2index(const QString &symName) const
{
...
QString EmojiEntityMapper::unicode(int index) const
{
  return index >= 0 && index < g_numEmojiEntities ? QString::fromLatin1(g_emojiEntities[index].unicode) : QString();
}

QString EmojiEntityMapper::name(int index) const
{
  return index >= 0 && index < g_numEmojiEntities ? QString::fromLatin1(g_emojiEntities[index].name) : QString();
}
