...
class UsedFilesContext : public RefCountedContext, public TemplateListIntf
{
 public:
   static UsedFilesContext *alloc(ClassDef *cd) {
      return new UsedFilesContext(cd);
   }
...
class NamespaceContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static NamespaceContext *alloc(NamespaceDef *nd) {
      return new NamespaceContext(nd);
   }
...
{
 public:
   static PageContext *alloc(PageDef *pd, bool isMainPage = false) {
      return new PageContext(pd, isMainPage);
   }
...
class ClassInheritanceContext : public RefCountedContext, public TemplateListIntf
{
 public:
   static ClassInheritanceContext *alloc() {
      return new ClassInheritanceContext;
   }
...
class ClassHierarchyContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static ClassHierarchyContext *alloc() {
      return new ClassHierarchyContext;
   }
...
class NamespaceTreeContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static NamespaceTreeContext *alloc() {
      return new NamespaceTreeContext;
   }
...
class PageListContext : public RefCountedContext, public TemplateListIntf
{
 public:
   static PageListContext *alloc(const PageSDict *pages) {
      return new PageListContext(pages);
   }
...
{
 public:
   static PageTreeContext *alloc() {
      return new PageTreeContext;
   }
...
class ModuleNodeContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static ModuleNodeContext *alloc(GroupDef *gd) {
      return new ModuleNodeContext(gd);
   }
...
class GlobalsIndexContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static GlobalsIndexContext *alloc() {
      return new GlobalsIndexContext();
   }
...
class ClassMembersIndexContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static ClassMembersIndexContext *alloc() {
      return new ClassMembersIndexContext();
   }
...
class NamespaceMembersIndexContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static NamespaceMembersIndexContext *alloc() {
      return new NamespaceMembersIndexContext();
   }
...
class NavPathElemContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static NavPathElemContext *alloc(Definition *def) {
      return new NavPathElemContext(def);
   }
...
{
 public:
   static InheritanceNodeContext *alloc(ClassDef *cd, const QByteArray &name) {
 ...
 private:
   InheritanceNodeContext(ClassDef *cd, const QByteArray &name);
...
{
 public:
   static MemberGroupInfoContext *alloc(Definition *def, const QByteArray &relPath, const MemberGroup *mg) {
 ...
 private:
   MemberGroupInfoContext(Definition *def, const QByteArray &relPath, const MemberGroup *mg);
...
{
 public:
   static MemberListInfoContext *alloc(Definition *def, const QByteArray &relPath,
                                       const MemberList *ml, const QByteArray &title,
                                       const QByteArray &subtitle = QByteArray()) {
 ...
 private:
   MemberListInfoContext(Definition *def, const QByteArray &relPath,
                         const MemberList *ml, const QByteArray &title,
                         const QByteArray &subtitle = QByteArray());
...
class MemberInfoContext : public RefCountedContext, public TemplateStructIntf
{
 public:
   static MemberInfoContext *alloc(const MemberInfo *mi) {
      return new MemberInfoContext(mi);
   }
...
{
 public:
   static InheritedMemberInfoContext *alloc(ClassDef *cd, MemberList *ml, const QByteArray &title) {
 ...
 private:
   InheritedMemberInfoContext(ClassDef *cd, MemberList *ml, const QByteArray &title);
...
class InheritedMemberInfoListContext : public RefCountedContext, public TemplateListIntf
{
 public:
   static InheritedMemberInfoListContext *alloc() {
      return new InheritedMemberInfoListContext;
   }
   void addMemberList(ClassDef *cd, MemberListType lt, const QByteArray &title, bool additionalList = true);
...
{
 public:
   static ArgumentContext *alloc(const Argument *arg, Definition *def, const QByteArray &relPath) {
 ...
 private:
   ArgumentContext(const Argument *arg, Definition *def, const QByteArray &relPath);
   ~ArgumentContext();
   class Private;
   Private *p;
};
...
class ArgumentListContext : public RefCountedContext, public TemplateListIntf
{
 public:
   static ArgumentListContext *alloc() {
      return new ArgumentListContext;
   }
   static ArgumentListContext *alloc(const ArgumentList *al, Definition *def, const QByteArray &relPath) {
 ...
 private:
   ArgumentListContext();
   ArgumentListContext(const ArgumentList *al, Definition *def, const QByteArray &relPath);
   ~ArgumentListContext();
   class Private;
   Private *p;
};
