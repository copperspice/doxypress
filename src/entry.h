...
class Entry : public EnableSharedFromThis
{
  public:
   ...
   enum Sections {
      ...
      NAMESPACEDOC_SEC = 0x00000200,
      INTERFACEDOC_SEC = 0x00000400,
      PROTOCOLDOC_SEC  = 0x00000800,
      CATEGORYDOC_SEC  = 0x00001000,
      SERVICEDOC_SEC   = 0x00002000,
      SINGLETONDOC_SEC = 0x00004000,
      ...
      SOURCE_SEC       = 0x00008000,
      HEADER_SEC       = 0x00010000,
      ...
      PACKAGEDOC_SEC   = 0x00a00000,
      PAGEDOC_SEC      = 0x00b00000,
      VARIABLEDOC_SEC  = 0x00c0d000,

      DEFINE_SEC       = 0x00d00000,
      ENUM_SEC         = 0x00e00000,
      EMPTY_SEC        = 0x00f00000,
      EXAMPLE_SEC      = 0x01000000,
      FUNCTION_SEC     = 0x02000000,
      INCLUDE_SEC      = 0x03000000,
      MEMBERGRP_SEC    = 0x04000000,
      OBJCIMPL_SEC     = 0x05000000,
      PACKAGE_SEC      = 0x06000000,
      TYPEDEF_SEC      = 0x07000000,
      USINGDECL_SEC    = 0x08000000,
      USINGDIR_SEC     = 0x09000000,
      VARIABLE_SEC     = 0x0a000000,

      EXPORTED_INTERFACE_SEC = 0x0b000000,
      INCLUDED_SERVICE_SEC   = 0x0c000000,
      EXAMPLE_LINENO_SEC     = 0x0d000000,
   };
