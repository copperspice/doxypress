...
class TranslatorCatalan : public TranslatorAdapter_1_8_0
{
 public:
   ...
   virtual QByteArray trFileListDescription(bool extractAll) {
      QByteArray result = "Aquesta és la llista de tots els fitxers ";
      if (!extractAll) {
         result += "documentats ";
      }
   ...
   virtual QByteArray trGeneratedAt(const char *date, const char *projName) {
      QByteArray result = (QByteArray)"Generat a " + date;
      if (projName) {
         result += (QByteArray)" per a " + projName;
      }
      result += (QByteArray)" per";
      return result;
   }

   /*! this text is put before a class diagram */
   virtual QByteArray trClassDiagram(const char *clName) {
      return (QByteArray)"Diagrama d'Herència per a " + clName + ":";
   }
   ...
   virtual QByteArray trNamespaceListDescription(bool extractAll) {
      QByteArray result = "Aquests són tots els espais de noms ";
      if (!extractAll) {
         result += "documentats ";
      }
   ...
   virtual QByteArray trCompoundReference(const char *clName,
                                          ...
                                          bool isTemplate) {
      QByteArray result = "Referència de";
      switch (compType) {
         case ClassDef::Class:
            result += " la Classe ";
            break;
   ...
   virtual QByteArray trFileReference(const char *fileName) {
      QByteArray result = "Referència del Fitxer ";
      result += fileName;
      return result;
   }
   ...
   virtual QByteArray trNamespaceReference(const char *namespaceName) {
      QByteArray result = "Referència de l'Espai de Noms ";
   ...
   virtual QByteArray trNamespaceMemberDescription(bool extractAll) {
      QByteArray result = "Aquesta és la llista de tots els membres de l'espai de noms ";
      if (!extractAll) {
         result += "documentats ";
      }
      result += "amb enllaços a ";
   ...
   virtual QByteArray trGeneratedFromFiles(ClassDef::CompoundType compType,
      ...
      QByteArray result = (QByteArray)"La documentació d'aquest";
      switch (compType) {
         case ClassDef::Class:
            result += "a classe";
            break;
   ...
   virtual QByteArray trCollaborationDiagram(const char *clName) {
      return (QByteArray)"Diagrama de col·laboració per a " + clName + ":";
   }
   /*! this text is put before an include dependency graph */
   virtual QByteArray trInclDepGraph(const char *fName) {
      return (QByteArray)"Inclou el graf de dependències per a " + fName + ":";
   }
   ...
   virtual QByteArray trFile(bool first_capital, bool singular) {
      QByteArray result((first_capital ? "Fitxer" : "fitxer"));
      if (!singular) {
         result += "s";
      }
      return result;
   ...
   virtual QByteArray trPage(bool first_capital, bool singular) {
      QByteArray result((first_capital ? "Pàgin" : "pàgin"));
      if (!singular) {
         result += "es";
      } else {
         result += "a";
   ...
   virtual QByteArray trDirReference(const char *dirName) {
      QByteArray result = "Referència del Directori ";
      result += dirName;
      return result;
   }
   ...
   virtual QByteArray trDir(bool first_capital, bool singular) {
      QByteArray result((first_capital ? "Directori" : "directori"));
      if (!singular) {
         result += "s";
      }
      return result;
   ...
   virtual QByteArray trCompoundMembersDescriptionFortran(bool extractAll) {
      QByteArray result = "Aquesta és la llista de tots els membres de tipus de dades";
      if (!extractAll) {
         result += " documentats";
      }
      result += " amb enllaços a ";
   ...
   virtual QByteArray trModulesListDescription(bool extractAll) {
      QByteArray result = "Aquesta és la llista de tots els mòduls ";
      if (!extractAll) {
         result += "documentats ";
      }
      result += "amb breus descripcions:";
   ...
   virtual QByteArray trModuleReference(const char *namespaceName) {
      QByteArray result = "Referència del Mòdul ";
      result += namespaceName;
      return result;
   }
   ...
   virtual QByteArray trModulesMemberDescription(bool extractAll) {
      QByteArray result = "Aquesta és la llista de tots els membres del mòdul";
      if (!extractAll) {
         result += " documentats";
      }
      result += " amb enllaços a ";
   ...
   virtual QByteArray trModule(bool first_capital, bool singular) {
      QByteArray result((first_capital ? "Mòdul" : "mòdul"));
      if (!singular) {
         result += "s";
      }
      return result;
    ...
    *  of the category.
    */
   virtual QByteArray trType(bool first_capital, bool) {
      QByteArray result((first_capital ? "Tipus" : "tipus"));
   ...
   virtual QByteArray trDirRelation(const char *name) {
      return QByteArray(name) + " Relació";
   }
   ...
   virtual QByteArray trFileIn(const char *name) {
      return (QByteArray)"Fitxer a " + name;
   }
   ...
   virtual QByteArray trIncludesFileIn(const char *name) {
      return (QByteArray)"Inclou fitxer a " + name;
   }
   ...
   virtual QByteArray trDirDepGraph(const char *name) {
      return QByteArray("Graf de dependència de directoris per a ") + name + ":";
   }
