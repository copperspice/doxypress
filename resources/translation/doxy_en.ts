...
<context>
    ...
    <message>
        ...
        <translation>This page explains how to interpret the graphs which are generated by DoxyPress.
...
\li %A box with a red border denotes a documented struct or class for which not all inheritance/containment relations are shown.
\li %A graph is truncated if it does not fit within the specified boundaries.
