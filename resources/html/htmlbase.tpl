...
<meta name="generator" content="DoxyPress {{ doxygen.version }}"/>
...
{% endblock %}
<!-- end header part -->
<!-- Generated by DoxyPress {{ doxygen.version }} -->
{% block search %}
...
{% endif %}
    ...
    <img class="footer" src="{{ page.relPath }}doxypress.png" alt="DoxyPress"/></a> {{ doxygen.version }} </li>
  </ul>
</div>
{% else %}
...
{{ tr.generatedby }}
{% endif %}
&#160;<a href="http://www.copperspice.org/cs_doxygen.html"><img class="footer" src="{{ page.relPath }}doxypress.png" alt="DoxyPress"/></a> 
  {{ doxygen.version }}
  </small></address>
{% endif %}
</body>
