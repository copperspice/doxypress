...
<meta name="generator" content="CS Doxygen {{ doxygen.version }}"/>
...
<body>
{% endblock %}
<div id="top"><!-- do not remove this div, it is closed by CS Doxygen -->
{% block titlearea %}
...
{% endblock %}
<!-- end header part -->
<!-- Generated by CS Doxygen {{ doxygen.version }} -->
{% block search %}
...
{{ tr.generatedby }}
{% endif %}
    <a href="http://www.copperspice.org/cs_doxygen.html">
    <img class="footer" src="{{ page.relPath }}cs-doxygen.png" alt="CS Doxygen"/></a> {{ doxygen.version }} </li>
  </ul>
</div>
{% else %}
...
{{ tr.generatedby }}
{% endif %}
&#160;<a href="http://www.copperspice.org/cs_doxygen.html"><img class="footer" src="{{ page.relPath }}cs-doxygen.png" alt="CS Doxygen"/></a> 
  {{ doxygen.version }}
  </small></address>
{% endif %}
</body>
